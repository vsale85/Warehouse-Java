...
public class PopupNabavkaPretraga extends JFrame{
	...
	public static Connection KonekcijaKaBazi() throws ClassNotFoundException {
	 ...
	 public static Connection konekcioniObj;
		 ...
		 */
		public PopupNabavkaPretraga(JTable tablePopUnos, JLabel kom,JLabel brt) {
			...
			getContentPane().setLayout(new GridLayout(1, 0, 0, 0));
				...
				info.addActionListener(new ActionListener() {						
					...
					public void actionPerformed(ActionEvent e) {
						...
						String column7 = tablePopUnos.getModel().getValueAt(row, 7).toString();
						 // create a JTextArea
			...
			//	popup.add(brisi);
				...
				izmena.addActionListener(new ActionListener() {			
					...
					public void actionPerformed(ActionEvent e) {
							...
							String kup = tablePopUnos.getModel().getValueAt(row, 5).toString();
							String stat = tablePopUnos.getModel().getValueAt(row, 6).toString();
							String nap = tablePopUnos.getModel().getValueAt(row, 8).toString();
															
						try {					
							PopupUpdateVulk.popUp(id, kup, stat, nap);
						} catch (Exception e2) {
